# Small App for EC2 with RDS database

This is a minimum viable Flask application to verify connectivity between an AWS EC2 instance (`ec2-user`) and an AWS RDS MySQL database.
...
- `deploy.sh`: Shell script to clone and set up the Python environment on your EC2 instance.
...
1. Launch an Amazon Linux 2023 / Amazon Linux 2 instance.
...
```
Transfer these files to the EC2 instance, or commit them to a Git repository and clone them.
...
2. Edit `.env` with your actual RDS credentials: `nano .env`
